      ...
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-custom-text mb-4">Work Experience</h2>
                ...
                <div className="p-8">
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
                    <div className="mb-4 lg:mb-0">
                      <h3 className="text-2xl font-bold text-custom-text mb-2 group-hover:text-custom-accent transition-colors duration-300">
                        {experience.position}
                      </h3>
                      <p className="text-xl gradient-text-secondary font-semibold mb-1">
                        {experience.company}
                      </p>
                      <div className="flex items-center text-custom-text-muted text-sm">
                    ...
                    <div className="flex-shrink-0">
                      <span className="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium bg-gradient-to-r from-custom-accent to-custom-accent-secondary text-white">
                  ...
                  <div className="mb-8">
                    <h4 className="text-lg font-semibold text-custom-text mb-4 flex items-center">
                      <svg className="w-5 h-5 mr-2 text-custom-accent" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <ul className="space-y-3">
                      {experience.description.map((item, idx) => (
                        <li key={idx} className="flex items-start">
                          <div className="flex-shrink-0 w-2 h-2 bg-gradient-to-r from-custom-accent to-custom-accent-secondary rounded-full mt-2 mr-3"></div>
                          <span className="text-custom-text-secondary leading-relaxed">{item}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
          ...
          <div className="mt-12">
            <div className="modern-card p-8">
              <h3 className="text-2xl font-bold text-custom-text text-center mb-6">Career Highlights</h3>
              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <p className="text-custom-text-secondary">IP Reports Managed</p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-custom-text-secondary">Process Automation Improvement</p>
                </div>
                <div className="text-center">
                  <div className="w-16 h-16 bg-gradient-to-br from-custom-accent-secondary to-pink-500 rounded-full flex items-center justify-center mx-auto mb-4">
                    <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <p className="text-custom-text-secondary">Years of Experience</p>
                </div>
              </div>
            </div>
          </div>
