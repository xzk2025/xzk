...
const Projects: React.FC = () => {
  const projects: Project[] = [
    ...
    },
    {
      ...
      description: "Modern, responsive portfolio website built with React and Tailwind CSS. Features dark theme, smooth animations, and professional design.",
                  ...
                  <div className="flex space-x-3">
                    {project.githubUrl && (
                      <a
                        ...
                        className="flex-1 bg-gray-700 hover:bg-gray-600 text-white text-center py-2 px-4 rounded-lg transition-colors duration-300 font-medium text-sm"
                      >
                    ...
                    {project.liveUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex-1 bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white text-center py-2 px-4 rounded-lg transition-all duration-300 font-medium text-sm"
                      >
