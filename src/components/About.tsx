          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-6">
              <div className="modern-card p-8">
                <h4 className="text-xl font-semibold text-white mb-6">What I Value</h4>
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full mr-3 mt-2"></div>
                    <div>
                      <span className="text-gray-300 font-medium">Data-Driven Decision Making</span>
                      <p className="text-gray-400 text-sm mt-1">Using evidence and analytics to guide strategic choices</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full mr-3 mt-2"></div>
                    <div>
                      ...
                      <p className="text-gray-400 text-sm mt-1">Staying current with technology and industry trends</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full mr-3 mt-2"></div>
                    <div>
                      <span className="text-gray-300 font-medium">Collaboration</span>
                      <p className="text-gray-400 text-sm mt-1">Working with teams to achieve shared goals</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="w-3 h-3 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full mr-3 mt-2"></div>
                    <div>
                      ...
                      <p className="text-gray-400 text-sm mt-1">Finding creative solutions to complex problems</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="modern-card p-6">
                <h4 className="text-lg font-semibold text-white mb-4">When I'm Not Working</h4>
              ...
              <div className="modern-card p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center">
                    <div className="w-3 h-3 bg-gradient-to-r from-orange-500 to-red-500 rounded-full mr-3"></div>
                    <span className="text-gray-300">Cloud Computing (AWS/Azure)</span>
                  </div>
                </div>
              </div>
            </div>
