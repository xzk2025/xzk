      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-custom-text mb-4">Education</h2>
            ...
            {education.map((edu) => (
              <div key={edu.id} className="modern-card p-8">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-xl font-semibold text-custom-text mb-2">{edu.degree}</h3>
                ...
                <div className="flex items-center text-custom-text-muted mb-4">
                ...
                <p className="text-custom-text-secondary mb-6 leading-relaxed">
                  {edu.description}
                </p>
                
                <div>
                  <h4 className="text-lg font-semibold text-custom-text mb-3">Key Achievements</h4>
                  <ul className="space-y-2">
                    {edu.achievements.map((achievement, idx) => (
                      <li key={idx} className="flex items-start">
                        ...
                        <span className="text-custom-text-secondary">{achievement}</span>
                      </li>
                    ))}
                  </ul>
                </div>
          ...
          <div className="mt-12 text-center">
            <div className="modern-card p-8 max-w-2xl mx-auto">
              <h3 className="text-2xl font-semibold text-custom-text mb-4">Professional Certifications</h3>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center">
                  <div className="w-16 h-16 bg-gradient-to-br from-custom-accent to-custom-accent-secondary rounded-full flex items-center justify-center mx-auto mb-2">
                    <span className="text-2xl">📊</span>
                  </div>
                  <p className="text-sm font-medium text-custom-text-secondary">Microsoft Power BI</p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-sm font-medium text-custom-text-secondary">Excel Expert</p>
                </div>
                <div className="text-center">
                  <div className="w-16 h-16 bg-gradient-to-br from-custom-accent-secondary to-pink-500 rounded-full flex items-center justify-center mx-auto mb-2">
                    <span className="text-2xl">🐍</span>
                  </div>
                  <p className="text-sm font-medium text-custom-text-secondary">Python Data Analysis</p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-sm font-medium text-custom-text-secondary">Business Analytics</p>
                </div>
              </div>
            </div>
          </div>
