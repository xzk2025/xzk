        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-12">
            ...
            <div className="modern-card p-8">
              <div className="text-center mb-8">
                ...
                <h3 className="text-2xl font-bold text-white mb-2">Data Analysis Tools</h3>
                <p className="text-gray-400">Business intelligence and data processing tools</p>
              </div>
              
              <div className="space-y-4">
                {dataAnalysisSkills.map((skill) => (
                  <div key={skill.name} className="flex items-center justify-between p-4 bg-custom-dark-lighter rounded-lg border border-white/5 hover:border-white/10 transition-all duration-300">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400 text-sm">{getSkillLevelText(skill.level)}</p>
                      </div>
                    </div>
            ...
            <div className="modern-card p-8">
              <div className="text-center mb-8">
                ...
                <h3 className="text-2xl font-bold text-white mb-2">Programming & Databases</h3>
                <p className="text-gray-400">Development languages and database technologies</p>
              </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="modern-card p-6 text-center">
              ...
              <p className="text-gray-400 text-sm">Business intelligence and reporting</p>
            </div>
            ...
            <div className="modern-card p-6 text-center">
              ...
              <p className="text-gray-400 text-sm">Full-stack development skills</p>
            </div>
            ...
            <div className="modern-card p-6 text-center">
              ...
              <p className="text-gray-400 text-sm">Process optimization and efficiency</p>
            </div>
          </div>
          
          {/* Learning Section */}
          <div className="modern-card p-8">
            <h3 className="text-2xl font-bold text-white text-center mb-8">Currently Learning</h3>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h4 className="text-lg font-semibold text-white mb-2">Machine Learning & AI</h4>
                <p className="text-gray-400 text-sm">Advanced analytics and automation</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-400 text-sm">AWS, Azure, and cloud platforms</p>
              </div>
              <div className="text-center">
                ...
                <h4 className="text-lg font-semibold text-white mb-2">Advanced Visualization</h4>
                <p className="text-gray-400 text-sm">Interactive dashboards and charts</p>
              </div>
            </div>
          </div>
        </div>
