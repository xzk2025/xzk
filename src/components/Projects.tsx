...
const Projects: React.FC = () => {
  const projects: Project[] = [
    ...
    },
    {
      ...
      description: "Modern, responsive portfolio website built with React and Tailwind CSS. Features light theme, smooth animations, and professional design.",
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project) => (
              <div key={project.id} className="modern-card group overflow-hidden">
                ...
                <div className="h-48 bg-gradient-to-br from-custom-accent/10 to-custom-accent-secondary/10 flex items-center justify-center">
                  <div className="text-center">
                    <div className="w-16 h-16 bg-gradient-to-br from-custom-accent to-custom-accent-secondary rounded-lg flex items-center justify-center mx-auto mb-4">
                    ...
                    <span className="text-sm text-custom-text-muted font-medium">{project.category}</span>
                  </div>
                </div>
                ...
                <div className="p-6">
                  ...
                  <p className="text-custom-text-secondary mb-4 leading-relaxed">
                    {project.description}
                  </p>
                  
                  {/* Technologies */}
                  <div className="mb-6">
                    <h4 className="text-sm font-semibold text-custom-text mb-2">Technologies Used</h4>
                  ...
                  <div className="flex space-x-3">
                    {project.githubUrl && (
                      <a
                        ...
                        className="flex-1 bg-gray-100 hover:bg-gray-200 text-custom-text text-center py-2 px-4 rounded-lg transition-colors duration-300 font-medium text-sm"
                      >
                    ...
                    {project.liveUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex-1 bg-gradient-to-r from-custom-accent to-custom-accent-secondary hover:from-custom-accent/90 hover:to-custom-accent-secondary/90 text-white text-center py-2 px-4 rounded-lg transition-all duration-300 font-medium text-sm"
                      >
          ...
          <div className="mt-12 text-center">
            <div className="modern-card p-8 max-w-2xl mx-auto">
              <h3 className="text-2xl font-bold text-custom-text mb-4">Interested in Working Together?</h3>
