...
const Header: React.FC = () => {
  ...
  return (
    <section id="home" className="relative py-12 sm:py-16 lg:py-20 font-inter overflow-hidden">
      ...
      <div className="absolute top-10 sm:top-20 left-10 sm:left-20 w-20 h-20 sm:w-32 sm:h-32 bg-gradient-to-r from-sky-accent/20 to-purple-500/20 rounded-full blur-2xl animate-pulse"></div>
      <div className="absolute bottom-10 sm:bottom-20 right-10 sm:right-20 w-24 h-24 sm:w-40 sm:h-40 bg-gradient-to-r from-indigo-500/20 to-sky-accent/20 rounded-full blur-2xl animate-pulse" style={{animationDelay: '2s'}}></div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="mb-6 sm:mb-8">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-1 sm:gap-2 text-sky-text-muted text-xs sm:text-sm mb-4">
                  <span className="flex items-center gap-1"><span className="text-green-500 text-sm sm:text-base">●</span>Available for hire</span>
                  <span className="hidden sm:inline mx-1">·</span>
                  <span className="flex items-center gap-1"><span className="text-sky-accent text-sm sm:text-base">🌍</span>Remote/Hybrid Available</span>
                </div>
              </div>
              
              {/* Social Links */}
              <div className="flex justify-center lg:justify-start space-x-4 sm:space-x-6 mb-6 sm:mb-8">
                <a href="https://www.linkedin.com/in/khinmyo-hsak-630ba2285/" target="_blank" rel="noopener noreferrer" 
                   className="group p-2.5 sm:p-3 bg-white/80 backdrop-blur-sm rounded-xl hover:bg-white transition-all duration-300 shadow-lg hover:shadow-xl">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-sky-text-secondary group-hover:text-sky-accent transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
             ...
             <div className="text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 px-4 sm:px-6 py-2.5 sm:py-3 rounded-xl bg-gradient-to-r from-sky-accent to-sky-accent-secondary text-white text-sm sm:text-base font-semibold shadow-md hover:shadow-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-sky-accent/40 active:scale-[0.99]"
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 px-4 sm:px-6 py-2.5 sm:py-3 rounded-xl border border-sky-accent/40 text-sky-accent bg-white/70 backdrop-blur-sm text-sm sm:text-base font-semibold shadow-sm hover:bg-sky-accent/10 hover:shadow-md transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-sky-accent/30 active:scale-[0.99]"
